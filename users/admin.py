...
class UserConfig(UserAdmin):
    ...
    list_filter = ('is_active','is_kyc','is_staff','is_superuser')
    ...
    fieldsets = (
        ...
        ('Status',{'fields':('msg','is_active','is_kyc','last_login','is_staff','is_superuser')}),
    )
    ...
    add_fieldsets = (
        ...
        ('Status',{'classes':('wide',),
        'fields':('is_active','is_kyc','is_staff','is_superuser')}),
    )
